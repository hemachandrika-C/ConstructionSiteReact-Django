            ...
            <div className="container gal">
                <div className="row">
                    <div className="col-lg-6">
                        <img src="https://i2.wp.com/www.twosisterscrafting.com/wp-content/uploads/2016/04/how-to-make-colored-whipped-cream-main.jpg" className="img-fluid gal_img1" />
                ...
                <div className="row pt-5">
                    ...
                    <div className="col-lg-6">
                    <img src="https://www.sbs.com.au/food/sites/sbs.com.au.food/files/styles/full/public/miko_aspiras_ube_cake.jpg?itok=iQtPc8yA"  className="img-fluid gal_img8" />
